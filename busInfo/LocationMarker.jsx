// This component locates the app user's location, and makes leaflet map do a fly-to animation to user's location. It displays a marker pin and a circle layer pf 100m radius at the user's location.
